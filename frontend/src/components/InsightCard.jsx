...
const InsightCard = ({ insight }) => {
    ...
    return (
        <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between h-full">
            ...
            <div className="flex items-start gap-2.5 mt-auto pt-4 border-t border-zinc-100 dark:border-zinc-800/50">
                <div className="flex items-center justify-center p-1 rounded-full bg-zinc-50 dark:bg-zinc-900 mt-0.5">
